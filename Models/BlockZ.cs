...
namespace Tetris.Models
{
    class BlockZ : IPlayerBlock
    {
        ...
        private static BlockZ _instance = new BlockZ();
        public BlockZ()
        {
            XPos = new int[4];
            YPos = new int[4];
        ...
        public static BlockZ GetInstance()
        {
            return _instance;
        }
        public void SetMode()
        {
            ...
            switch (Mode)
            {
                ...
                default:
                    throw new Exception("BlockZ supports 2 modes of rotation only");
            }
        }
