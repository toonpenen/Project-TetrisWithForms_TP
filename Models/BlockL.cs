...
namespace Tetris.Models
{
    class BlockL : IPlayerBlock
    {
        ...
        private static BlockL _instance = new BlockL();
        private BlockL()
        {
            XPos = new int[4];
            YPos = new int[4];
        ...
        public static BlockL GetInstance()
        {
            return _instance;
        }
        public void SetMode()
        {
            ...
            switch (Mode)
            {
                ...
                case 4:
                    ...
                    break;
                default:
                    throw new Exception("BlockL supports 4 modes of rotation only");
            }
        }
